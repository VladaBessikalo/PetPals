document.addEventListener('DOMContentLoaded', () => {
    ...
    function scrollToSection(event) {
        ...
        const targetId = event.target.getAttribute('href') || '#pets'; 
    ...
    function navigation() {
        const links = document.querySelectorAll('.nav__menu-link, .banner__link-btn');
        links.forEach(link => {
    ...
    adoptMeBtns.forEach(button => {
        button.addEventListener('click', () => showModal("Adopter's Form"));
    });
    ...
    /* There was one problem with Codepen - the standard behavior of the submission form did not work. I assume it was due to some security settings in Codepen.  To do this, I changed the default behavior of the submit form so that when you click on the "Submit" button, the form is submitted ( submitBtn.addEventListener('click', () =>  {}, insted of form.addEventListener('submit', () =>  {}.*/
